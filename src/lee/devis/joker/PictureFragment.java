...
//        listView.setOnScrollListener(new PauseOnScrollListener(imageLoader, true, true));
    ...
    private Handler myHandler = new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what) {
                case R.id.tag_get_picture:
                    Log.i("TTT", "myHandler  tag_get_picture");
    ...
    public void onDetach() {
        ...
        if (handler != null) handler.removeCallbacksAndMessages(handler);
    }
    ...
    public void onDestroyView() {
        ...
        if (handler != null) {
            handler.removeCallbacksAndMessages(myHandler);
            handler = null;
        }
        super.onDestroyView();
    }
    ...
    private void refresh() {
        jokes.clear();
        currentPage = 1;
        new AsynTaskThread(myHandler, R.id.tag_get_picture, currentPage).execute();
    }
